...
const List<MissionTemplate> achievementMissions = [
  // ── TIER 1: EASY ──
  MissionTemplate(id: 'a_dist_1k', title: 'First Flight', description: 'Travel 2,000m in one run', type: MissionType.achievement, category: MissionCategory.distance, target: 2000, coinReward: 100, xpReward: 20, isSingleRun: true),
  MissionTemplate(id: 'a_dist_5k', title: 'Novice Pilot', description: 'Travel 7,500m in one run', type: MissionType.achievement, category: MissionCategory.distance, target: 7500, coinReward: 300, stardustReward: 2, xpReward: 50, isSingleRun: true),
  MissionTemplate(id: 'a_coins_100', title: 'Piggy Bank', description: 'Collect 250 coins total', type: MissionType.achievement, category: MissionCategory.coins, target: 250, coinReward: 50, xpReward: 10),
  MissionTemplate(id: 'a_aliens_10', title: 'Bug Splat', description: 'Destroy 25 aliens total', type: MissionType.achievement, category: MissionCategory.aliens, target: 25, coinReward: 100, xpReward: 20),
  MissionTemplate(id: 'a_boss_1', title: 'First Blood', description: 'Defeat 2 Bosses', type: MissionType.achievement, category: MissionCategory.boss, target: 2, coinReward: 500, stardustReward: 5, xpReward: 100),
  MissionTemplate(id: 'a_combo_10', title: 'Combo Starter', description: 'Reach 15 combo streak', type: MissionType.achievement, category: MissionCategory.combo, target: 15, coinReward: 100, xpReward: 20, isSingleRun: true),
  MissionTemplate(id: 'a_powerup_1', title: 'Powered Up', description: 'Collect 5 Power-ups', type: MissionType.achievement, category: MissionCategory.powerup, target: 5, coinReward: 50, xpReward: 10),
  MissionTemplate(id: 'a_runs_5', title: 'Cadet', description: 'Play 10 runs', type: MissionType.achievement, category: MissionCategory.survival, target: 10, coinReward: 100, xpReward: 20),
  MissionTemplate(id: 'a_physics_1', title: 'Anomalous', description: 'Survive 3 Physics Modes', type: MissionType.achievement, category: MissionCategory.physics, target: 3, coinReward: 100, xpReward: 20),
  MissionTemplate(id: 'a_shop_1', title: 'Consumer', description: 'Buy 3 items from Shop', type: MissionType.achievement, category: MissionCategory.shop, target: 3, coinReward: 10, xpReward: 5),
  ...
  // Filler Achievements
  MissionTemplate(id: 'a_dist_1500', title: 'Step 1', description: 'Travel 2,000m', type: MissionType.achievement, category: MissionCategory.distance, target: 2000, coinReward: 20, isSingleRun: true),
  MissionTemplate(id: 'a_dist_2500', title: 'Step 2', description: 'Travel 3,000m', type: MissionType.achievement, category: MissionCategory.distance, target: 3000, coinReward: 30, isSingleRun: true),
  MissionTemplate(id: 'a_dist_3500', title: 'Step 3', description: 'Travel 4,500m', type: MissionType.achievement, category: MissionCategory.distance, target: 4500, coinReward: 40, isSingleRun: true),
  MissionTemplate(id: 'a_dist_7500', title: 'Step 4', description: 'Travel 9,000m', type: MissionType.achievement, category: MissionCategory.distance, target: 9000, coinReward: 80, isSingleRun: true),
  MissionTemplate(id: 'a_dist_15k', title: 'Step 5', description: 'Travel 20,000m', type: MissionType.achievement, category: MissionCategory.distance, target: 20000, coinReward: 150, isSingleRun: true),
  MissionTemplate(id: 'a_coins_200', title: 'Saver 1', description: 'Collect 300 coins total', type: MissionType.achievement, category: MissionCategory.coins, target: 300, coinReward: 50),
  MissionTemplate(id: 'a_coins_300', title: 'Saver 2', description: 'Collect 450 coins total', type: MissionType.achievement, category: MissionCategory.coins, target: 450, coinReward: 75),
  MissionTemplate(id: 'a_coins_400', title: 'Saver 3', description: 'Collect 600 coins total', type: MissionType.achievement, category: MissionCategory.coins, target: 600, coinReward: 100),
  MissionTemplate(id: 'a_coins_600', title: 'Saver 4', description: 'Collect 900 coins total', type: MissionType.achievement, category: MissionCategory.coins, target: 900, coinReward: 125),
  MissionTemplate(id: 'a_coins_800', title: 'Saver 5', description: 'Collect 1,200 coins total', type: MissionType.achievement, category: MissionCategory.coins, target: 1200, coinReward: 150),
  MissionTemplate(id: 'a_aliens_20', title: 'Hunter 1', description: 'Kill 30 aliens', type: MissionType.achievement, category: MissionCategory.aliens, target: 30, coinReward: 50),
  MissionTemplate(id: 'a_aliens_30', title: 'Hunter 2', description: 'Kill 50 aliens', type: MissionType.achievement, category: MissionCategory.aliens, target: 50, coinReward: 60),
  MissionTemplate(id: 'a_aliens_40', title: 'Hunter 3', description: 'Kill 75 aliens', type: MissionType.achievement, category: MissionCategory.aliens, target: 75, coinReward: 70),
  MissionTemplate(id: 'a_combo_15', title: 'Flow 1', description: '20 Combo', type: MissionType.achievement, category: MissionCategory.combo, target: 20, coinReward: 50, isSingleRun: true),
  MissionTemplate(id: 'a_combo_25', title: 'Flow 2', description: '30 Combo', type: MissionType.achievement, category: MissionCategory.combo, target: 30, coinReward: 75, isSingleRun: true),
  MissionTemplate(id: 'a_combo_35', title: 'Flow 3', description: '45 Combo', type: MissionType.achievement, category: MissionCategory.combo, target: 45, coinReward: 100, isSingleRun: true),
  MissionTemplate(id: 'a_combo_45', title: 'Flow 4', description: '60 Combo', type: MissionType.achievement, category: MissionCategory.combo, target: 60, coinReward: 125, isSingleRun: true),
  MissionTemplate(id: 'a_physics_2', title: 'Adapt 1', description: 'Survive 4 physics modes total', type: MissionType.achievement, category: MissionCategory.physics, target: 4, coinReward: 50),
  MissionTemplate(id: 'a_physics_4', title: 'Adapt 2', description: 'Survive 8 physics modes total', type: MissionType.achievement, category: MissionCategory.physics, target: 8, coinReward: 100),
  MissionTemplate(id: 'a_physics_6', title: 'Adapt 3', description: 'Survive 12 physics modes total', type: MissionType.achievement, category: MissionCategory.physics, target: 12, coinReward: 150),
  MissionTemplate(id: 'a_physics_8', title: 'Adapt 4', description: 'Survive 16 physics modes total', type: MissionType.achievement, category: MissionCategory.physics, target: 16, coinReward: 200),
  MissionTemplate(id: 'a_boss_2', title: 'Duelist 1', description: 'Defeat 3 bosses total', type: MissionType.achievement, category: MissionCategory.boss, target: 3, coinReward: 100),
  MissionTemplate(id: 'a_boss_3', title: 'Duelist 2', description: 'Defeat 5 bosses total', type: MissionType.achievement, category: MissionCategory.boss, target: 5, coinReward: 150),
  MissionTemplate(id: 'a_boss_4', title: 'Duelist 3', description: 'Defeat 7 bosses total', type: MissionType.achievement, category: MissionCategory.boss, target: 7, coinReward: 200),
  MissionTemplate(id: 'a_runs_10', title: 'Regular 1', description: 'Play 20 runs', type: MissionType.achievement, category: MissionCategory.survival, target: 20, coinReward: 50),
  MissionTemplate(id: 'a_runs_25', title: 'Regular 2', description: 'Play 50 runs', type: MissionType.achievement, category: MissionCategory.survival, target: 50, coinReward: 100),
  MissionTemplate(id: 'a_powerup_10', title: 'Collector 1', description: 'Collect 20 powerups total', type: MissionType.achievement, category: MissionCategory.powerup, target: 20, coinReward: 50),
  MissionTemplate(id: 'a_powerup_25', title: 'Collector 2', description: 'Collect 50 powerups total', type: MissionType.achievement, category: MissionCategory.powerup, target: 50, coinReward: 100),
  MissionTemplate(id: 'a_powerup_75', title: 'Collector 3', description: 'Collect 150 powerups total', type: MissionType.achievement, category: MissionCategory.powerup, target: 150, coinReward: 200),
  MissionTemplate(id: 'a_powerup_150', title: 'Collector 4', description: 'Collect 250 powerups total', type: MissionType.achievement, category: MissionCategory.powerup, target: 250, coinReward: 300),
];
