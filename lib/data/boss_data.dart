...
class BossPhase {
  ...
  const BossPhase({required this.healthThreshold, required this.attacks, this.attackSpeedMult = 1.0, this.armorMult = 1.0});
}
...
const List<BossConfig> allBosses = [
  ...
  BossConfig(
    ...
    movement: BossMovement.circleOrbit,
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.5, attackSpeedMult: 2.0, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.5, attackSpeedMult: 1.6, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.4, attackSpeedMult: 1.5, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.5, armorMult: 0.5, attackSpeedMult: 1.5, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.66, attacks: [
      ...
      BossPhase(healthThreshold: 0.33, attackSpeedMult: 1.5, attacks: [
  ...
  BossConfig(
    ...
    movement: BossMovement.sway, rebirth: true,
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.5, armorMult: 1.0, attackSpeedMult: 1.5, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.5, attackSpeedMult: 1.8, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.33, attackSpeedMult: 1.6, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.5, attackSpeedMult: 1.5, armorMult: 0.5, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.5, armorMult: 0.1, attackSpeedMult: 1.5, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.75, attacks: [
      ...
      BossPhase(healthThreshold: 0.5, attacks: [
      ...
      BossPhase(healthThreshold: 0.25, attackSpeedMult: 2.0, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.8, attacks: [
      ...
      BossPhase(healthThreshold: 0.6, attacks: [
      ...
      BossPhase(healthThreshold: 0.4, attacks: [
      ...
      BossPhase(healthThreshold: 0.2, attackSpeedMult: 2.0, attacks: [
  ...
  BossConfig(
    ...
    phases: [
      ...
      BossPhase(healthThreshold: 0.83, attacks: [
      ...
      BossPhase(healthThreshold: 0.25, armorMult: 0.3, attacks: [
      ...
      BossPhase(healthThreshold: 0.1, attackSpeedMult: 2.5, attacks: [
